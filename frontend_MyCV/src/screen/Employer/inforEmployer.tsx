...
const InforEmployer  = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get('http:/10.101.30.249:3000/employers');
    ...
    const handleUpdate = async (employer: Employer) => {
        try {
            ...
            const response = await axios.put(`http://10.101.30.249:3000/employers/${employer.id}`, employer);
    ...
    const handleDelete = async (id: string) => {
        try {
            ...
            await axios.delete(`http://10.101.30.249:3000/employers/${id}`);
